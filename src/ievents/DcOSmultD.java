...
import market.PriceMultiD;

/**
 * The multidimensional version of DcOS class. The description of the multidimensional approach is provided in the paper
 * "Multidimensional Directional-Change Intrinsic Time Applied to FX data"
 */
public class DcOSmultD {
    ...
    public DcOSmultD(double delta){
        this.delta = delta; osL = 0;
        initialized = false;
    }


    public int run(PriceMultiD priceMultiD){
        double[] aPrice = priceMultiD.getMid().clone(); // TODO: to change it to the inner price
