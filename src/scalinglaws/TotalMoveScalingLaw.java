 ...
 * Created by author.
 *
 * This class is dedicated to the computation of the "Total move scaling law", Law 9(tm) from
 * the "Patterns in high-frequency FX data: Discovery of 12 empirical scaling laws".
 *
 * One of the results of the computation is a file with two columns: Delta, TotalMove.
...
public class TotalMoveScalingLaw {
     ...
     * @param numPoints
     */
    public TotalMoveScalingLaw(float lowDelta, float higDelta, int numPoints){
    ...
    public void saveResults(String dirName){
        ...
        try {
            ...
            String fileName = "9_totalMoveScalingLaw" + "_" + dateString + ".csv";
            PrintWriter writer = new PrintWriter(dirName + "/" + fileName, "UTF-8");
            writer.println("Delta;TotalMove");
            for (int i = 0; i < numPoints; i++){
